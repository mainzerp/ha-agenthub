...
async def _seed_defaults(db: aiosqlite.Connection) -> None:
    ...
    default_agents = [
        ("orchestrator", 1, "groq/llama-3.1-8b-instant", 10, 3, 0.3, 4096, "Intent classification and task routing"),
        ("light-agent", 1, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Lighting control"),
        ("music-agent", 1, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Music and media playback"),
        ("general-agent", 1, "openrouter/openai/gpt-4o-mini", 5, 3, 0.5, 2048, "Fallback and general Q&A"),
        (
        ...
        ("timer-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Timers and alarms"),
        ("calendar-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Calendar event management"),
        ("climate-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Climate, HVAC, fans, and humidifiers"),
        ("media-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Media player control"),
        ("cover-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Cover and blind control"),
        ("vacuum-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Robot vacuum control"),
        ("scene-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Scene activation"),
        ("automation-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Automation management"),
        ("security-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Security system control"),
        ("lists-agent", 0, "openrouter/openai/gpt-4o-mini", 5, 3, 0.2, 2048, "Todo and shopping list management"),
        (
            "send-agent",
            0,
            "openrouter/openai/gpt-4o-mini",
